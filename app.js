...
function verifFunc(tabResultats) {
    ...
    afficherResulats(verifTableau);
    couleursFonction(verifTableau);
    verifTableau = [];
}

function afficherResulats(tabCheck) {
...
function couleursFonction(tabValBool) {
    for(let j = 0; j < tabValBool.length; j++){
        ...
        if(tabValBool[j] === true) {
            ...
            toutesLesQuestions[j].classList.add('reussite');
        }
        else{
            ...
            setTimeout(() => {
                ...
                toutesLesQuestions[j].classList.remove('reussite');
            }, 500);
        }
